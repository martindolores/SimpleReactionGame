pipeline {
    ...
    stages {
        ...
        stage('Deploy to Staging') {
            steps {
                script {
                    def scpExitCode = sh(returnStatus: true, script: 'scp -i "C:/Users/marti/Downloads/jenkins-linux.pem" -r "C:/Users/marti/Documents/Study/Deakin/2023/T1/Professional Practice In Information Technology/Task 6.2C/SimpleReactionGame" ec2-user@54.253.240.3:/home/ec2-user/Staging')
                    if (scpExitCode != 0) {
                    error "scp command failed with exit code ${scpExitCode}"
                }
            }
        }
