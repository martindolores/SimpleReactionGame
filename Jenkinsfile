        ...
        stage('Deploy to Staging') {
            steps {
                script {
                    ...
                    bat 'plink -batch -i "C:\Users\marti\Downloads\jenkins-linux.ppk" -hostkey "ssh-ed25519:yIEy8p3s8oQZaIoKsFJKNSrvaXZwrAfo0KGYLlNRpCs" ec2-user@54.253.240.3 exit'
